...
DATASET$Intervention_Age_Effects <- AGE_EFFECTS
...
DATASET$Intervention_DietAge_Effects <- DIETAGE_EFFECTS
...
write_csv(
  ...
  paste0(
    ...
    '_intervention_age_effects_conditioned_on_diet.csv'
  )
)
...
write_csv(
  ...
  paste0(
    'results/', DATASET$Assay,
    '_intervention_diet_age_interaction_effects.csv'
  )
)
