# Diet and age effects on PIXImus phenotypes

This directory contains the results of the analysis of diet and age effects on phenotypes measured by the PIXImus assay (dual energy x-ray aborptiometry densitometer: body composition traits). For each phenotype, the direct effects of diet and age were estimated as well as the interaction between diet and age (i.e. the diet-specific effects of age). 
